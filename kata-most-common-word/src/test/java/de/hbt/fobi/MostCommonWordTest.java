...
public class MostCommonWordTest {
    ...
    public static Object[][] testcases() {
        return new Object[][]{
                ...
                {
                        "hallo du hallo da hallo",
                        new String[]{"hallo", "du"},
                        "da",
                },
                {
                        "Bob hit a ball, the hit BALL flew far after it was hit.",
                        new String[]{"hit", "hit", "hit", "hit"},
                        "ball",
                },
                {
                        "Bob hit a ball, the hit BALL flew far after it was hit.",
    ...
    void test1(String paragraph, String[] banned, String expectedOutput) {
        //when
        MostCommonWord mcw = new MostCommonWord();
        String result = mcw.solution(paragraph, banned);
        //then
